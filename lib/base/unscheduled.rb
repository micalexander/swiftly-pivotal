module SwiftlyPivotal
  class Unscheduled < Thor
    ...
    desc "track unscheduled PROJECT_NAME", "Track unscheduled"
    ...
    def unscheduled( project_name )
      ...
      stories = SwiftlyPivotal::PivotalTracker.stories 0, 'unscheduled'
      ...
      while answer = ask(set_color('Load 5 more or enter number to expand', :yellow, :bold ),  :limited_to => allowed)
        ...
        stories = SwiftlyPivotal::PivotalTracker.stories loaded, 'unscheduled'
      ...
      say 'No more unscheduled'
    end

    default_task :unscheduled
  end
end
